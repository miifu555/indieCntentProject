// 出典: QRCoder (https://github.com/codebude/QRCoder) v1.4.3 より、
// Unity組み込み用にPayloadGenerator依存の一部オーバーロードのみ削除して取り込み。
// QRCoder is licensed under the MIT License. See QRCoder_LICENSE.txt.
using System;
